package com.github.voxelfriend.dyntreescuisine.proxy;
...
import com.github.voxelfriend.dyntreescuisine.ModTrees;
...
public class ClientProxy extends CommonProxy {
	...
	public void registerModels() {
		...
		ModelHelper.regModel(ModBlocks.citrusLog);
		
		//TREE PARTS
		
		//Register Meshers for Branches and Seeds
		for(TreeFamily tree: ModTrees.citrusTrees) {
